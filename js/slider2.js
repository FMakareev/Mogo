...
var slidContainer = document.getElementById('someofourwork__slide-list');
// переключатель вправо
var rightArrow = document.getElementById('someofourwork__slider-arrow-right');
rightArrow.addEventListener("click", right);
// переключатель влево
var leftArrow = document.getElementById('someofourwork__slider-arrow-left');
...
function right(){
    ...
    var sliderList = document.getElementById('someofourwork__slide-list').getElementsByClassName('someofourwork__slide-item');
